    ...
    >
      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          ...
          <li class="items-center">
            <a
              class="text-blue-700 hover:text-blue-500 text-xs uppercase py-3 font-bold block"
              href="#/landing"
              ><i class="fas fa-newspaper text-blue-400 mr-2 text-sm"></i>
              Landing Page</a
            >
          </li>
          <li class="items-center">
            <a
              class="text-blue-700 hover:text-blue-500 text-xs uppercase py-3 font-bold block"
              href="#/profile"
              ><i class="fas fa-user-circle text-blue-400 mr-2 text-sm"></i>
              Profile Page</a
            >
          </li>
          <li class="items-center">
            <a
              class="text-blue-700 hover:text-blue-500 text-xs uppercase py-3 font-bold block"
              href="#/login"
              ><i class="fas fa-fingerprint text-blue-400 mr-2 text-sm"></i>
              Login</a
            >
          </li>
          <li class="items-center">
            <a
              class="text-blue-300 text-xs uppercase py-3 font-bold block"
              href="#pablo"
              ><i
                class="fas fa-clipboard-list text-blue-300 mr-2 text-sm"
              ></i>
              Register</a
            >
          </li>
        ...
        <!-- Heading -->
        <!-- <h6
          class="md:min-w-full text-blue-500 text-xs uppercase font-bold block pt-1 pb-4 no-underline"
        >
          Documentation
        </h6> -->
        <!-- Navigation -->
        ...
        >
          <li class="inline-flex">
            <a
              class="text-blue-700 hover:text-blue-500 text-sm block mb-4 no-underline font-semibold"
              href="#/documentation/styles"
              ><i
                class="fas fa-paint-brush mr-2 text-blue-400 text-base"
              ></i>
              Styles</a
            >
          </li>
          <li class="inline-flex">
            <a
              ...
              ><i class="fab fa-css3-alt mr-2 text-blue-400 text-base"></i>
              CSS Components</a
            >
          </li>
          <li class="inline-flex">
            <a
              ...
              ><i class="fab fa-vuejs mr-2 text-blue-400 text-base"></i>
              VueJS</a
            >
          </li>
          <li class="inline-flex">
            <a
              ...
              ><i class="fab fa-react mr-2 text-blue-400 text-base"></i>
              React</a
            >
          </li>
          <li class="inline-flex">
            <a
              ...
              ><i class="fab fa-angular mr-2 text-blue-400 text-base"></i>
              Angular</a
            >
          </li>
          <li class="inline-flex">
            <a
              ...
              ><i class="fab fa-js-square mr-2 text-blue-400 text-base"></i>
              Javascript</a
            >
          </li>
        </ul> -->
